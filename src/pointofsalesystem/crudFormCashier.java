...
public final class crudFormCashier extends javax.swing.JFrame {
    ...
    public void Connect(){
        try {
            ...
            Logger.getLogger(crudFormCashier.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Product id", "Name", "Category", "Price Small", "Price Medium", "Price Large", "Quantity"
            }
        ));
                                                ...
                                                .addGroup(jPanel2Layout.createSequentialGroup()
                                                    .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                        ...
                                                        .addGroup(jPanel2Layout.createSequentialGroup()
                                                            ...
                                                            .addGap(28, 28, 28)
                                                            .addComponent(pMed, javax.swing.GroupLayout.PREFERRED_SIZE, 55, javax.swing.GroupLayout.PREFERRED_SIZE)))
                                                    .addGap(34, 34, 34)
                                                    .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGap(5, 5, 5)
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(pMed, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 36, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                .addComponent(pSmall, javax.swing.GroupLayout.PREFERRED_SIZE, 36, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addComponent(pLg, javax.swing.GroupLayout.PREFERRED_SIZE, 36, javax.swing.GroupLayout.PREFERRED_SIZE))))
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
      ...
      if (txtName.getText().isEmpty()) {
        ...
        JOptionPane.showMessageDialog(this, "Product Quantity Required!");
        ...
        try {
            ...
            pst = con.prepareStatement("INSERT INTO products (name, category, small, medium, large, quantity, image) VALUES (?, ?, ?, ?, ?, ?, ?)");
            ...
            pst.setString(7, destinationPath);  // Store relative path
...
destinationPath = destinationPath.replace("\\", "/");
            ...
            if (destinationPath != null) {
                pst = con.prepareStatement("UPDATE products SET name = ?, category = ?, small = ?, medium = ?, large = ?, quantity = ?, image = ? WHERE id = ?");
                pst.setString(1, name);
                pst.setString(2, category);
                pst.setInt(3, small);
                pst.setInt(4, medium);
                pst.setInt(5, large);
                pst.setInt(6, quantity);
                pst.setString(7, destinationPath); // Update the image path
                pst.setInt(8, id);
            } else {
                pst = con.prepareStatement("UPDATE products SET name = ?, category = ?, small = ?, medium = ?, large = ?, quantity = ? WHERE id = ?");
                pst.setString(1, name);
                pst.setString(2, category);
                pst.setInt(3, small);
                pst.setInt(4, medium);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       new CashierDashboard().setVisible(true); // Open new frame
           dispose();
...
if (result == JFileChooser.APPROVE_OPTION) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(crudFormCashier.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
